...
@Database(entities = {UserInfo.class, ProjectInfo.class, Category.class, Project.class, Field.class, LookUpValue.class, Contribution.class, Geometry.class, ContributionProperty.class}, version = 1, exportSchema = false)
